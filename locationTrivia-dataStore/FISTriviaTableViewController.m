...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"triviaProtoCell" forIndexPath:indexPath];
    
    // Configure the cell...
    
    FISTrivium *passedTrivium = self.location.trivia[indexPath.row];
    
    cell.textLabel.text = passedTrivium.content;
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%li",passedTrivium.likes];
